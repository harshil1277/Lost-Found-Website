<?php
	...
	if(isset($_POST['txtFirstName']) and isset($_POST['txtLastName']) and isset($_POST['txtMobileNumber']))
	{
			...
			$query="update adminmaster set FirstName='{$firstName}',LastName='{$lastName}',LastName='{$lastName}',MobileNumber='{$mobil}' where EmailID='$login_session'";
